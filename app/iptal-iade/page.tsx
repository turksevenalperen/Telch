...
export const metadata: Metadata = {
  title: "İptal & İade Şartları | Uçak Bileti İptal Koşulları - bilethizmeti.com",
  description:
    "bilethizmeti.com uçak bileti iptal ve iade koşulları, yolcu hakları ve tazminat bilgileri. Havayolu şirketlerine göre iptal şartları ve EU 261 yolcu hakları.",
          ...
          <div className="max-w-4xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-lg text-muted-foreground text-pretty">
                bilethizmeti.com uçak bileti iptal ve iade koşulları, yolcu hakları ve tazminat bilgileri
              </p>
            </div>
                  ...
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-muted-foreground space-y-2">
                        ...
                        <li>• bilethizmeti.com hizmet bedeli iade kapsamı dışındadır</li>
                      </ul>
                    </div>
                  </div>
                </Card>
            ...
            <Card className="p-8 text-center bg-primary/5">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  href="mailto:info@bilethizmeti.com"
