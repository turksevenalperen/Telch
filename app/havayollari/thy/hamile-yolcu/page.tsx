...
export default function THYHamileYolcuPage() {
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-muted-foreground md:text-xl text-pretty">
              Gebelik döneminde güvenli uçuş için kurallar ve öneriler.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <Card className="p-6 hover:shadow-lg transition-shadow border-yellow-200">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li className="flex items-center gap-2">
                    <AlertTriangle className="h-4 w-4 text-yellow-600 shrink-0" />
                    <span>Uçuştan 7 gün önce</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <AlertTriangle className="h-4 w-4 text-yellow-600 shrink-0" />
                    <span>&quot;Uçuşa uygundur&quot; ibaresi</span>
                  </li>
                </ul>
              </Card>
              ...
              <Card className="p-6 hover:shadow-lg transition-shadow border-red-200">
                ...
                <p className="text-sm text-muted-foreground text-center mb-4">Uçuş tavsiye edilmez</p>
                <ul className="space-y-2 text-sm">
                  <li className="flex items-center gap-2">
                    <AlertTriangle className="h-4 w-4 text-red-600 shrink-0" />
                    <span>Genellikle kabul edilmez</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <AlertTriangle className="h-4 w-4 text-red-600 shrink-0" />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="p-6 border-purple-200">
              <div className="flex items-start gap-4">
                <Heart className="h-8 w-8 text-purple-600 shrink-0" />
                <div>
                  ...
                  <p className="mt-4 text-sm bg-purple-50 p-3 rounded-lg">
                    Çoğul gebeliklerde süreler tekil gebeliklere göre daha kısadır. Lütfen önceden bilgi alın.
                  </p>
                </div>
              </div>
            </Card>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Card className="p-6">
                <h3 className="font-bold mb-4 flex items-center gap-2">
                  ...
                  Doktor Raporu İçeriği
                </h3>
                <ul className="space-y-2 text-sm">
                  <li>• Gebelik haftası</li>
                  <li>• Tahmini doğum tarihi</li>
                  <li>• Tekil/çoğul gebelik bilgisi</li>
              ...
              <Card className="p-6">
                ...
                <ul className="space-y-2 text-sm">
                  <li>• Uçuştan en fazla 7 gün önce alınmalı</li>
                  <li>• İngilizce veya Türkçe olmalı</li>
                  <li>• Gidiş-dönüş uçuşları kapsamalı</li>
      ...
      <section className="py-16 bg-accent/30">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold mb-8 text-center">Uçuş Sırasında Tavsiyeler</h2>
            
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {[
                { baslik: "Bol Su İçin", aciklama: "Dehidratasyonu önlemek için düzenli su tüketin." },
                { baslik: "Hareket Edin", aciklama: "Her 1-2 saatte ayağa kalkıp yürüyün." },
                { baslik: "Koridor Koltuğu", aciklama: "Kolay hareket için koridor kenarı tercih edin." },
                { baslik: "Emniyet Kemeri", aciklama: "Kemeri karnınızın altından geçirin." },
                { baslik: "Rahat Giysiler", aciklama: "Bol ve rahat kıyafetler tercih edin." },
                { baslik: "Destek Çorabı", aciklama: "Kan dolaşımı için kompresyon çorabı kullanın." },
              ].map((item) => (
      ...
      <section className="py-16 bg-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="mb-8 opacity-90">
            Gebelik döneminde seyahat planlamanız için uzman desteği alın.
          </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              {[
                { title: "THY Engelli Yolcu", href: "/havayollari/thy/engelli-yolcu" },
