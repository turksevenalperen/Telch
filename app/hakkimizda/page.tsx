...
export const metadata: Metadata = {
  title: "Hakkımızda - bilethizmeti.com | 14 Yıllık Deneyim, IATA & TÜRSAB Üyesi",
  description:
    "bilethizmeti.com 2010'dan beri Türkiye'nin güvenilir seyahat acentesi. 5M+ mutlu müşteri, 150+ destinasyon, IATA ve TÜRSAB üyesi. 14 yıllık tecrübe ile güvenli seyahat hizmeti.",
  keywords: "bilethizmeti.com hakkında, seyahat acentesi, IATA üyesi, TÜRSAB üyesi, havayolu bileti, güvenilir seyahat",
  openGraph: {
    title: "Hakkımızda - bilethizmeti.com | 14 Yıllık Deneyim",
      ...
      <section className="py-20 bg-accent/20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-balance">Rakamlarla bilethizmeti.com</h2>
          </div>
